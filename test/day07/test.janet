...
(def test-file "test/day07/test.txt")
(def input-file "test/day07/input.txt")

(def result-part1 (part1 (file/open test-file :r)))
(def result-part2 (part2 (file/open test-file :r)))
(def exp-result-part1 21)
(def exp-result-part2 40)
...
(when (os/lstat input-file)
  ...
  (def exp-result-part1 1537)
  (def exp-result-part2 18818811755665)
